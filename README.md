...
4. API is available at `http://localhost:8080/api/about`
5. Follow example below for further instructions.
...
3. API is available at `http://localhost:8080/api/about`
4. Follow example below for further instructions.

## Example:
1. Go to `http://localhost:8080/api/about`.
2. Go to `http://localhost:8080/api/departments`.
3. Choose a department ID.
4. Go to `http://localhost:8080/api/departments/{deptID}/courses`.
5. Choose a course ID.
6. Go to `http://localhost:8080/api/departments/{deptID}/courses/{courseID}/offerings`.
7. Choose a course offering ID.
8. Go to `http://localhost:8080/api/departments/{deptID}/courses/{courseID}/offerings/{offeringID}`.
